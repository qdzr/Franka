...
class ViewpointEntropyCalculator:
    ...
    def _depth_img_callback(self, msg):
        ...
        print("depth image topic callback")
    def update_service_handler(self, req):
        ...
        with TimeIt('Total'):
            ...
            with TimeIt('Response'):
                ...
                print("update_service_handler callback and publish the image to topic ~visualisation")
        ...
        if False:
            ...
            np.savez('/home/gh/data/np/%d.npz'%self.counter, **kwargs)
            self.counter += 1
    ...
    def reset_gridworld(self, req):
        ...
        self.counter = 0
        print("reset_gridworld service callback")
    ...
    def add_failure_point_callback(self, req):
        ...
        print("add_failure_point_callback service callback")
