...
class PandaOpenLoopGraspController(object):
    ...
    def __init__(self):
        ...
        self.test_pose.position.x = 0.309781797142
        self.test_pose.position.y = 0.0001173
        self.test_pose.position.z = 0.5816160
        self.test_pose.orientation.x =  0.924679761962
        self.test_pose.orientation.y = -0.380292086381
        self.test_pose.orientation.z = -0.0117397899281
        self.test_pose.orientation.w = 0.0142993379913
...
if __name__ == '__main__':
    rospy.init_node('linemod_open_loop_grasp')
    p = gmsg.Pose()
    p.position.x = -0.04
    p.position.y = -0.45
    p.position.z = 0.589984428162
    p.orientation.x = 2**0.5/2
    p.orientation.y = -2**0.5/2
    p.orientation.z = 0.0
    p.orientation.w = 0.0
    q = gmsg.Pose()
    q.position.x = 0.309982937615
    q.position.y = 0.000309774062229
    q.position.z = 0.58178603682
    q.orientation.x = 0.92461467465
    q.orientation.y = -0.380481108632
    q.orientation.z = -0.0116273270377
    q.orientation.w = 0.0136614297315
