...
class PandaCommander(object):
    ...
    def set_named_poses(self):
        ...
        self.active_group.remember_joint_values('grip_ready')
        self.active_group.remember_joint_values('drop_box')
    ...
    def goto_pose(self, pose, velocity=1.0, group_name=None, wait=True):
        ...
        pose.position.z = max(pose.position.z, 0.035)
        self.active_group.set_goal_position_tolerance(0.01)
        self.active_group.set_goal_orientation_tolerance(0.01)
